...
<script type="text/x-red" data-template-name="aws-sdk-config">
	...
	<div id="node-config-aws-config-tabs-content" style="min-height: 170px;">
		<div id="aws-config-tab-connection" style="display:none">
			...
			<div class="form-row node-input-accesskey">
				<label for="node-config-input-accesskey"><i class="fa fa-link"></i> <span>Access Key</span></label>
					<input class="input-append-left" type="text" id="node-config-input-accesskey" placeholder="AWS Access Key" style="width: 40%;" >
			</div>
			<div class="form-row node-input-secretkey">
				<label for="node-config-input-secretkey"><i class="fa fa-edit"></i> <span>Secret Key</span></label>
				<input type="password" id="node-config-input-secretkey" placeholder="AWS Secret Key" style="width: 40%;">
			</div>
			<div class="form-row">
